...
# (omitted: image/video source parsing and setup blocks)
# ...
...
while True:
    ...
    bean_is_present = ir_sensor.is_active 
    ...
    cv2.putText(frame, f'IR Active: {bean_is_present}', (10,60), cv2.FONT_HERSHEY_SIMPLEX, .7, (0,255,255), 2)
    cv2.imshow('YOLO detection results',frame)
    if record: recorder.write(frame)

    # (omitted: rest of the keypress/FPS calculation/cleanup logic)
    # ...
